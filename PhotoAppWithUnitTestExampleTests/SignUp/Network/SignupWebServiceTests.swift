...
class SignupWebServiceTests: XCTestCase {
    ...
    override func setUp() {
        ...
        signFormRequestModel = SignupFormRequestModel(firstName: "Yurii", lastName: "Yurii", email: "12@1.com", password: "98765432")
    }
    ...
    func testSignupWebService_WhenURLRequestFails_ReturnsErrorMessageDescription() {
        ...
        //MockURLProtocol.error = SignupError.failedRequest(description: errorDescription)It does not work.
