...
struct SignupConstants {
   static let firstNameMinLength = 2
    ...
    static let signupURLString = "https://tlyqhtlbn8.execute-api.us-east-1.amazonaws.com/prod/signup-mock-service/users" //"http://appsdeveloperblog.com:8080/signup-mock-service/users"
}
